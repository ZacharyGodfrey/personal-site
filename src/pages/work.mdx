...
Technologies: C#, ASP.NET MVC and WebAPI, Dapper ORM, HTML5, CSS3, JavaScript, jQuery
...
Technologies: C#, ASP.NET MVC and WebAPI, Entity Framework, MSSQL, HTML5, CSS3, JavaScript, Angular, PHP
